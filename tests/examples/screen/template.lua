...
local function reserve_clip(outer, inner)
    --TODO
end
...
local function draw_info(s)
    ...
    local dx = (s.geometry.width*factor - col1_width - col2_width - 5)/2
