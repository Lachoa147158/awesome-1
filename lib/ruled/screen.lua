...
srules:add_property_setter("split", function(s, value, props, callbacks)
    ...
    -- Apply the rules to the new screens.
    for _, scr in ipairs(ns) do
        if s ~= scr then
            srules:_execute(scr, new_props, callbacks)
        end
    end
end)

--- How to redistribute the tags when a screen is removed.
--
-- By default, `ruled.screen.tag_redistribution.all_by_group` is used
-- when a `group` is set. Otherwise, `ruled.screen.tag_redistribution.none` is
-- used.
--
-- ruled.screen.tag_redistribution.none
-- ruled.screen.tag_redistribution.used_only_by_history
-- ruled.screen.tag_redistribution.used_only_focued_screen
-- ruled.screen.tag_redistribution.used_only_by_group
-- ruled.screen.tag_redistribution.all_by_history
-- ruled.screen.tag_redistribution.all_by_group
-- ruled.screen.tag_redistribution.all_focused_screen
-- ruled.screen.tag_redistribution.suspend
--
-- @clientruleproperty tag_redistribution

srules:add_property_setter("tag_redistribution", function(s, value)

end)

--- How to redistribute clients when a screen is removed.
--
-- TODO
--
-- ruled.screen.client_redistribution.rules
-- ruled.screen.client_redistribution.none
--
-- @clientruleproperty client_redistribution

srules:add_property_setter("client_redistribution", function(s, value)
