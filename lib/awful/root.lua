...
for _, type_name in ipairs { "button", "key" } do
    ...
    capi.root["add_"..type_name] = function(value)
    ...
    capi.root["add_"..prop_name] = function(values)
        ...
        for _, value in ipairs(values) do
            capi.root["add_"..type_name](value)
        end
    end

    capi.root["remove_"..type_name] = function(value)
