...
local function custom_template(args)
    ...
    -- For now, only there is no better way. If template could implement this
    -- function even if it doesn't use the declarative construct.
    assert(l.get_children_by_id)
