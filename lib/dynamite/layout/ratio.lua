...
-- @tilinglib dynamite.layout.ratio
---------------------------------------------------------------------------
...
--- As the layout may have random subdivisions.
--
-- Makes sure to call their "raise" too.
--
...
-- @constructorfct dynamite.layout.ratio.horizontal
...
-- equally among all widgets. Widgets can be added via :add(widget).
-- @tparam widget ... Widgets that should be added to the layout.
-- @constructorfct dynamite.layout.ratio.vertical
